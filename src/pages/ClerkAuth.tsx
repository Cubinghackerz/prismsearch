...
const ClerkAuth = () => {
  ...
  const prismAppearance = {
    elements: {
      ...
      cardBox: "bg-gray-900/80 backdrop-blur-md border border-gray-700/50 rounded-xl shadow-2xl",
      main: "bg-gray-900/80 backdrop-blur-md rounded-xl",
      ...
      socialButtonsBlockButton: "w-full bg-gray-800/90 hover:bg-gray-700/90 text-white border border-gray-600/70 rounded-lg h-12 text-sm font-medium transition-all duration-200 flex items-center justify-center gap-3 hover:border-gray-500 font-inter backdrop-blur-sm",
      socialButtonsBlockButtonText: "text-white font-medium",
      socialButtonsProviderIcon: "w-5 h-5",
      dividerLine: "bg-gray-600/50",
      dividerText: "text-gray-400 text-sm uppercase tracking-wide font-inter",
      formButtonPrimary: "w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-lg h-12 text-sm font-medium transition-all duration-200 shadow-lg font-inter",
      formFieldInput: "w-full px-4 py-3 border border-gray-600/70 bg-gray-800/90 rounded-lg text-sm text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 transition-all duration-200 font-inter backdrop-blur-sm",
      formFieldLabel: "text-sm font-medium text-white mb-2 font-inter",
      footerActionLink: "text-blue-400 hover:text-blue-300 underline underline-offset-4 font-inter transition-colors duration-200",
      footerActionText: "text-gray-400 font-inter",
      footerAction: "flex justify-center mt-6",
      footer: "mt-6"
    },
    ...
    variables: {
      ...
      colorBackground: "rgba(17, 17, 17, 0.95)",
      colorInputBackground: "rgba(31, 41, 55, 0.9)",
