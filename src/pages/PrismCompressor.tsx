...
const PrismCompressor = () => {
  ...
  const allFormats = compressionOptions.flatMap(option => option.formats);
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-prism-text-muted mt-2 font-inter">
                Compress files while retaining quality - support for images, documents, audio, video, and more
              </p>
            </div>
          </div>
          ...
          <Alert className="border-blue-500/30 bg-blue-500/5">
            ...
            <AlertDescription className="text-blue-300">
              <strong>Smart Compression:</strong> Our algorithms automatically optimize compression settings 
              based on file type to achieve the best size reduction while maintaining quality.
            </AlertDescription>
          </Alert>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <Card className="mt-6">
              ...
              <CardContent className="space-y-3 text-sm text-prism-text-muted">
                <div className="flex items-start space-x-2">
                  <div className="w-2 h-2 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p>Images: Use JPEG for photos, PNG for graphics with transparency</p>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p>Documents: PDF compression maintains formatting and text quality</p>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p>Audio: Higher bitrates preserve more detail but increase file size</p>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-2 h-2 bg-orange-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p>Video: Balance quality and file size based on your needs</p>
                </div>
              </CardContent>
            </Card>
          </div>
...
export default PrismCompressor;
