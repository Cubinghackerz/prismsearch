...
const Chat = () => {
  ...
  return <div className="min-h-screen flex flex-col bg-[#0E141B]">
      ...
      <header className="py-6 px-4 relative z-10">
        ...
        duration: 0.5
      }} className="text-center relative flex items-center justify-between max-w-7xl mx-auto">
          ...
          <div className="flex-1">
            ...
            repeat: Infinity,
            repeatType: 'reverse'
          }} className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 animate-gradient-text text-center">Prism Chat</motion.h1>
          </div>
