    ...
    <div className="w-full max-w-6xl mx-auto p-6 space-y-6">
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-prism-text-muted max-w-2xl mx-auto">
          ...
          Solve stoichiometry, equilibrium, organic reactions, thermodynamics, and more with detailed solutions.
        </p>
      </div>
...
• Calculate molarity of 2.5 mol NaCl in 500 mL solution
• Find pH of 0.1 M HCl solution
• Determine the limiting reagent in 2A + 3B → C reaction"
