    ...
    return (
      <input
        ...
        className={cn(
          ...
          // Enhanced hover state with smoother transition
          "hover:border-orange-500/50 hover:bg-orange-900/25",
          // Improved focus state with subtle glow effect
          "relative focus-visible:shadow-[0_0_0_1px_rgba(255,158,44,0.3),0_0_8px_rgba(255,158,44,0.2)]",
          className
        )}
        ref={ref}
        {...props}
