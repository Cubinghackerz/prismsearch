...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-inter",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-r from-orange-400 to-orange-600 hover:from-orange-500 hover:to-orange-700 text-white shadow-lg shadow-orange-600/10 hover:shadow-orange-600/20 border border-orange-500/30",
        ...
        outline: "border border-orange-500/30 bg-transparent hover:bg-orange-500/10 text-orange-100",
        ...
        ghost: "hover:bg-orange-500/10 text-orange-100 hover:text-orange-50",
        link: "text-orange-400 underline-offset-4 hover:underline hover:text-orange-300",
        gradient: "bg-gradient-to-r from-orange-400 to-teal-400 hover:from-orange-500 hover:to-teal-500 text-white shadow-lg shadow-orange-500/20 hover:shadow-orange-500/40 border-none",
      },
      size: {
