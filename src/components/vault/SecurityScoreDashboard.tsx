...
export const SecurityScoreDashboard: React.FC<SecurityScoreDashboardProps> = ({ passwords }) => {
  ...
  const analyzePasswordStrengths = (password: string): string[] => {
    ...
    if (password.length >= 16) strengths.push('Excellent length (16+ characters)');
    else if (password.length >= 12) strengths.push('Good length (12+ characters)');
  ...
  const toggleNoteVisibility = (id: string) => {
    setShowNoteContent(prev => ({ ...prev, [id]: !prev[id] }));
  };
  ...
  const getScoreBadge = (score: number) => {
    ...
    if (score >= 75) return { label: 'STRONG', color: 'bg-green-600' };
    if (score >= 60) return { label: 'GOOD', color: 'bg-cyan-600' };
    if (score >= 40) return { label: 'FAIR', color: 'bg-amber-600' };
        ...
        <CardContent>
          <div className="flex space-x-2 mb-6">
            <Button
              ...
              size="sm"
              className={activeTab === 'overview' ? 'bg-cyan-600 hover:bg-cyan-700' : 'border-slate-600'}
            >
            ...
            <Button
              ...
              size="sm"
              className={activeTab === 'history' ? 'bg-cyan-600 hover:bg-cyan-700' : 'border-slate-600'}
            >
            ...
            <Button
              ...
              size="sm"
              className={activeTab === 'notes' ? 'bg-cyan-600 hover:bg-cyan-700' : 'border-slate-600'}
            >
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                {recentPasswords.map((password, index) => {
                  ...
                  return (
                    <div key={password.id} className="bg-slate-800/30 rounded-lg p-4">
                    ...
                    <div key={password.id} className="bg-slate-800/30 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          {password.created_at !== password.updated_at && (
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <Badge 
                            className={password.breach_status === 'safe' ? 'bg-emerald-600' : 'bg-red-600'}
                          >
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  />
                  <Textarea
                    placeholder="Your private note content (encrypted)..."
                ...
                {encryptedNotes.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {encryptedNotes.map((note) => (
                      <div key={note.id} className="bg-slate-800/30 rounded-lg p-4">
